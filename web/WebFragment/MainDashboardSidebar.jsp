...
<aside
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="SubjectTable">
                    <div
                        class="
                        icon icon-shape icon-sm
                        shadow
            ...
            <li class="nav-item">
                <a class="nav-link" href="PostTable">
                    <div
                        class="
                        icon icon-shape icon-sm
                        shadow
            ...
            <li class="nav-item">
                <a class="nav-link ${quizactive}" href="QuizTable">
                    <div
                        class="
                        icon icon-shape icon-sm
                        shadow
                    ...
                    <span class="nav-link-text ms-1">Quiz Management</span>
                </a>
            </li>
            <li class="nav-item">
