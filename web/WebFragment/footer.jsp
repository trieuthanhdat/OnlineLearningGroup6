            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer-widget">
                    ...
                    <div class="contact-info">
                        <p><i class="fa fa-map-marker"></i>FPT university, Ho Chi Minh, VietNam</p>
                        <p><i class="fa fa-envelope"></i>OnlineLearningSystemGroup6z@gmail.com</p>
                        <p><i class="fa fa-phone"></i>+84 718 5920</p>
                        <div class="social">
...
<script src="assets/js/CourseSlides.js"></script>
...
<!-- Student also enroll courses js -->
