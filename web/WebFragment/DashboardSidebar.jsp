...
<c:if test="${not empty POST_LIST}">
    <c:set var="postactive" value="active">
    </c:set>
</c:if>
<c:if test="${not empty ENABLED_SUBJECTS_LIST || not empty DISABLED_SUBJECTS_LIST }">
    <c:set var="subjectactive" value="active">
    </c:set>
</c:if>
...
<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="Dashboard">
            <span class="ms-1 font-weight-bolder">Online Learning System</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link ${useractive}" href="UserTable">
                    <div
                        class="
                        icon icon-shape icon-sm
                        shadow
            ...
            <li class="nav-item">
                <a class="nav-link ${subjectactive}" href="SubjectTable">
                    <div
                        class="
                        icon icon-shape icon-sm
                        shadow
            ...
            <li class="nav-item">
                <a class="nav-link ${postactive}" href="PostTable">
                    <div
                        class="
                        icon icon-shape icon-sm
                        shadow
            ...
            <li class="nav-item">
                <a class="nav-link ${quizactive}" href="QuestionTable">
                    <div
                        class="
                        icon icon-shape icon-sm
                        shadow
    ...
    <div class="sidenav-footer mx-3 mt-3 pt-3">
        <div
            ...
            <div
                ...
                style="
                background-image: url('DashboardAssets/img/curved-images/white-curved.jpeg');
                "
                ></div>
