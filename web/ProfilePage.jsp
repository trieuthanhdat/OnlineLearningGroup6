...
<section class="py-5 my-5">
    <div class="container">
        <h1 class="mb-5" style="    padding: 2% 1%;
            background: #1f1f1f;
            color: white;
            height: 90px;
            text-align: center;
            ...
            17deg
            , #000000d9, #0000008f);">Account Settings</h1>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="txtName" class="form-control" value="${CURRENT_USER.fullName}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Address</label>
                                    <textarea type="text" class="form-control" name="txtAddress" >${CURRENT_PROFILE.address}</textarea>
                                </div>
                            </div>
