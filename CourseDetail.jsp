        ...
        <div class="container">
            ...
            <div class="body-breadcumb" style="display: flex;  flex-wrap: wrap;">
                <div class="col-lg-8">
                    ...
                    <div class="body-breadcumb-nav" style="text-align: left;">
                        <button class="btn" style="background: #ff6f61;">
                            Subscribe now
                        </button>
                    </div>
                </div>
                        ...
                        <div
                            ...
                            <div class="fees">
                                <c:forEach items="${CURRENT_SUBJECT.packages}" var="paList">
                                    <p>
                                        ${paList.listPrice-paList.salePrice}VND/${paList.accessduration} Tháng<br>
                                    </p>
                                </c:forEach>
                            </div>
                        </div>
            ...
            <section class="container aos-init aos-animate" style="    padding: 0;">
                <div class="sidebar-option col-lg-8" style="    padding: 0;">
                    <div class="hardware-guides">
                        ...
                        <c:forEach var="first" items="${MORE_SUBJECT}" end="0">
                                <a
                                    data-toggle="popover"
                                    data-placement="top"
                                    title="Brief Info"
                        ...
                        <!-- more items here -->
                        <c:forEach var="list" items="${MORE_SUBJECT}" begin="1">
