...
public class QuizErrorDTO {
    private String InvalidLessonID;
    ...
    private String FailToChangeError;

    public QuizErrorDTO() {
    }

    public void setFailToChangeError(String FailToChangeError) {
        this.FailToChangeError = FailToChangeError;
    }

    public String getFailToChangeError() {
        return FailToChangeError;
    }

    public void setInvalidLessonID(String InvalidLessonID) {
        this.InvalidLessonID = InvalidLessonID;
    }

    public String getInvalidLessonID() {
        return InvalidLessonID;
    }
