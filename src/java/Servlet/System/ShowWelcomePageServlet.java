...
public class ShowWelcomePageServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (url.equals(WELCOME_PAGE)) {
            ...
            session.setAttribute("POST_LIST", postdao.getPostList());
            session.setAttribute("RECENT_POSTS", postdao.get5LatestPosts());
            log("RECENT_POSTS_SIZE: " + String.valueOf(postdao.get5LatestPosts().size()));
            session.setAttribute("FEATURED_POSTS", postdao.getFeaturedPosts());
            log("FEATURED_POSTS: " + String.valueOf(postdao.getFeaturedPosts().size()));
            session.setAttribute("SLIDER_LIST", sliderdao.getAvailableSliders());
