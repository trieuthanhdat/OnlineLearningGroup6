...
public class Mail {
    ...
    public static void SendEmailToNewUser(String newUserEmail, String newPassword) 
            throws MessagingException {
        String toEmail = newUserEmail;
        ...
        try {
            ...
            // Set Subject: header field
            message.setSubject("Online Learning System: System has created for you a new account");

            // Now set the actual message
            message.setText("You've just recently joined our system. Email: " + newUserEmail + " - Password: " + newPassword);
